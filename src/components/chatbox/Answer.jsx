            ...
            ? messages?.map((message, i) => (
                <div className="responses " key={i}>
                  ...
                  {message.role === 'user' ? (
                    <div
                      id="user-responose"
                      className="group py-2 flex flex-1 text-base mx-auto gap-3 md:px-5 lg:px-1 xl:px-5 md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem] } group"
                    >
                      ...
                      <div className="relative flex w-full flex-col lg:w-[calc(100%-115px)] agent-turn">
                        ...
                        <svg
                          ...
                          className="hidden group-hover:block icon-md mb-4 text-gray-400 hover:text-white"
                        >
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
